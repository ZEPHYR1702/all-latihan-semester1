...
namespace all_latihan
{
    internal class week9
    {
        ...
        public static void L1()
        {
            ...
            int.TryParse(Console.ReadLine(), out int lantai);
            Console.Write("Banyaknya kamar tiap lantai: ");
            int.TryParse(Console.ReadLine(), out int kamarPerLantai);
            Console.Write("Banyaknya kamar yang tersewa: ");
            int.TryParse(Console.ReadLine(), out int kamarTersewa);
            ...
            for (int i = 0; i < kamarTersewa; i++)
            {
                ...
                int.TryParse(Console.ReadLine(), out int lantaiKamar);
                Console.Write($"Kamar ke: ");
                int.TryParse(Console.ReadLine(), out int nomorKamar);
        ...
        public static void L2()
        {
            ...
            int.TryParse(Console.ReadLine(), out int baris);
            Console.Write("Banyaknya kolom = ");
            int.TryParse(Console.ReadLine(), out int kolom);
            ...
            int.TryParse(Console.ReadLine(), out int jumTanam);
            int noBaris, noKolom;
            char tanaman;
            for (int i = 0; i < jumTanam; i++)
            {
                Console.Write("Nomor baris = ");
                int.TryParse(Console.ReadLine(), out noBaris);
                Console.Write("Nomor kolom = ");
                int.TryParse(Console.ReadLine(), out noKolom);

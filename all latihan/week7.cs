...
namespace all_latihan
{
    internal class week7
    {
        ...
        public static void L1()
        {
            ...
            int.TryParse(Console.ReadLine(), out int batas);
        ...
        public static void L2()
        {
            ...
            int.TryParse(Console.ReadLine(), out int batasAkhir);
        ...
        public static void L4()
        {
            ...
            int.TryParse(Console.ReadLine(), out int jenis);
            ...
            for (int i = 1; i <= jenis; ++i)
            {
                ...
                int.TryParse(Console.ReadLine(), out int tr);

                for (int j = 0; j < tr; ++j)
                {
                    Console.Write("Jumlah barang (keluar/masuk): ");
                    int.TryParse(Console.ReadLine(), out int jum);
                    stok += jum;
                }
        ...
        public static void L8()
        {
            ...
            for (int t = 1; t <= n; ++t)
            {
                ...
                for (int b = 1; b <= 12; ++b)
                {
                    ...
                    int.TryParse(Console.ReadLine(), out int setoran);
                    tab += setoran;
                }
            }
        ...
        public static void L10()
        {
            ...
            int.TryParse(Console.ReadLine(), out int mhs);
            Console.Write("Input jumlah tugas : ");
            int.TryParse(Console.ReadLine(), out int tgs);
            ...
            for (int t = 1; t <= tgs; ++t)
            {
                ...
                for (int m = 1; m <= mhs; ++m)
                {
                    ...
                    int.TryParse(Console.ReadLine(), out int nilai);
                    total += nilai;
                }
        ...
        public static void L11()
        {
            ...
            for (int i = 1; accSks < 24; ++i)
            {
                ...
                int.TryParse(Console.ReadLine(), out int sks);
        ...
        public static void L12()
        {
            ...
            int.TryParse(Console.ReadLine(), out int awal);
            Console.Write("Nilai akhir : ");
            int.TryParse(Console.ReadLine(), out int akhir);

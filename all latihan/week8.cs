    ...
    internal class week8
    {
        ...
        public static void L1()
        {
            ...
            for (int i = 0; i < 7; i++)
            {
                ...
                int.TryParse(Console.ReadLine(), out penjualan[i]);
            }
            Console.WriteLine("Batas bawah: ");
            int.TryParse(Console.ReadLine(), out int batasBawah);
            Console.WriteLine("Batas atas: ");
            int.TryParse(Console.ReadLine(), out int batasAtas);
        ...
        public static void L3()
        {
            ...
            {
                Console.Write($"Hari ke-{i + 1}: ");
                int.TryParse(Console.ReadLine(), out hari[i]);
            }

            Console.Write("Persentase kenaikan:");
            double.TryParse(Console.ReadLine(), out persentase);
            persentase /= 100;
            Console.WriteLine();
        ...
        public static void L5()
        {
            ...
            for (int i = 0; i < suhu.Length; i++)
            {
                ...
                int.TryParse(Console.ReadLine(), out suhu[i]);
            }
            Console.WriteLine();
        ...
        public static void L6()
        {
            ...
            int.TryParse(Console.ReadLine(), out int jumlah);
            ...
            for (int i = 0; i < jumlah; i++)
            {
                ...
                int.TryParse(Console.ReadLine(), out sks[i]);
        ...
        public static void L7()
        {
            ...
            int.TryParse(Console.ReadLine(), out int jumlahMahasiswa);

            for (int i = 0; i < jumlahMahasiswa; i++)
            {
                Console.WriteLine($"Data mahasiswa ke-{i + 1}:");
                Console.Write("NRP: ");
                int.TryParse(Console.ReadLine(), out NRP[i]);
                Console.Write("NTS: ");
                int.TryParse(Console.ReadLine(), out NTS[i]);
                Console.Write("NAS: ");
                int.TryParse(Console.ReadLine(), out NAS[i]);
            }
